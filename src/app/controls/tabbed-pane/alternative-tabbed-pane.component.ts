    ...
    */
    template: `
        <div class="tabbed-pane">
            ...
            <template [flightUnless]="tabsArray.length === 0">
                <div>
            ...
            <template flightRepeate [flightRepeateOf]="tabsArray" let-tab let-i="index">
...
export class AlternativeTabbedPaneComponent
    ...
    get tabsCount() {
        ...
        let array: Array<AlternativeTabComponent> = this.tabs.toArray();
